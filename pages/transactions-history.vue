  ...
  <div class="dashboard-wrapper-light-notrad responsive-content-wrapper">
    <div class="center vertical">
      ...
      <div class="wallet-wrapper">
        <transactions-history-table :is-loading="refreshingPage" :histories="histories"/>
      </div>
    </div>
  </div>
</template>
...
<script>
import TransactionsHistoryTable from "@/components/_sections/transactions_history/TransactionsHistoryTable";
